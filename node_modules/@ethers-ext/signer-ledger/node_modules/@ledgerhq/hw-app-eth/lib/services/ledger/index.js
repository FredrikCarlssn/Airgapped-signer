...
var index_1 = require("@ledgerhq/domain-service/signers/index");
 ...
 */
var resolveTransaction = function (rawTxHex, loadConfig, resolutionConfig) { return __awaiter(void 0, void 0, void 0, function () {
    var rawTx, _a, decodedTx, chainIdTruncated, domains, contractAddress, selector, resolutions, shouldResolve, pluginsResolution, contractResolution, domainResolutions;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 3:
                ...
                return [2 /*return*/, (0, utils_1.mergeResolutions)(resolutions)];
        }
    });
}); };
exports["default"] = {
