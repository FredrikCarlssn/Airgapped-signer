...
var Domains_1 = require("./modules/Domains");
...
var Eth = /** @class */ (function () {
    ...
    Eth.prototype.signTransaction = function (path, rawTxHex, resolution) {
        return __awaiter(this, void 0, void 0, function () {
            var _loop_1, this_1, _a, _b, domainDescriptor, e_1_1, _c, _d, plugin, e_2_1, _e, _f, _g, payload, signature, e_3_1, _h, _j, nft, e_4_1, _k, _l, data, e_5_1, rawTx, _m, vrsOffset, txType, chainId, chainIdTruncated, paths, response, offset, _loop_2, this_2, response_byte, v, oneByteChainId, ecc_parity, r, s;
            ...
            return __generator(this, function (_t) {
                switch (_t.label) {
                    ...
                    case 1:
                        ...
                        _t.label = 2;
                    case 2:
                        if (!resolution) return [3 /*break*/, 38];
                        _loop_1 = function (domainDescriptor) {
                            return __generator(this, function (_u) {
                                switch (_u.label) {
                                    case 0: return [4 /*yield*/, (0, Domains_1.domainResolutionFlow)(this_1, domainDescriptor)["catch"](function (e) {
                    ...
                    case 3:
                        ...
                        _a = __values(resolution.domains), _b = _a.next();
                        _t.label = 4;
                    case 4:
                        if (!!_b.done) return [3 /*break*/, 7];
                        domainDescriptor = _b.value;
                        return [5 /*yield**/, _loop_1(domainDescriptor)];
                    case 5:
                        _t.sent();
                        _t.label = 6;
                    case 6:
                    ...
                    case 9:
                        ...
                        return [7 /*endfinally*/];
                    case 10:
                        _t.trys.push([10, 15, 16, 17]);
                        _c = __values(resolution.plugin), _d = _c.next();
                        _t.label = 11;
                    case 11:
                        if (!!_d.done) return [3 /*break*/, 14];
                        plugin = _d.value;
                        return [4 /*yield*/, this.setPlugin(plugin)];
                    case 12:
                        _t.sent();
                        _t.label = 13;
                    case 13:
                    ...
                    case 16:
                        ...
                        return [7 /*endfinally*/];
                    case 17:
                        _t.trys.push([17, 22, 23, 24]);
                        _e = __values(resolution.externalPlugin), _f = _e.next();
                        _t.label = 18;
                    case 18:
                        if (!!_f.done) return [3 /*break*/, 21];
                        _g = _f.value, payload = _g.payload, signature = _g.signature;
                        return [4 /*yield*/, this.setExternalPlugin(payload, signature)];
                    case 19:
                        _t.sent();
                        _t.label = 20;
                    case 20:
                    ...
                    case 23:
                        ...
                        return [7 /*endfinally*/];
                    case 24:
                        _t.trys.push([24, 29, 30, 31]);
                        _h = __values(resolution.nfts), _j = _h.next();
                        _t.label = 25;
                    case 25:
                        if (!!_j.done) return [3 /*break*/, 28];
                        nft = _j.value;
                        return [4 /*yield*/, this.provideNFTInformation(nft)];
                    case 26:
                        _t.sent();
                        _t.label = 27;
                    case 27:
                    ...
                    case 30:
                        ...
                        return [7 /*endfinally*/];
                    case 31:
                        _t.trys.push([31, 36, 37, 38]);
                        _k = __values(resolution.erc20Tokens), _l = _k.next();
                        _t.label = 32;
                    case 32:
                        if (!!_l.done) return [3 /*break*/, 35];
                        data = _l.value;
                        return [4 /*yield*/, this.provideERC20TokenInformation(data)];
                    case 33:
                        _t.sent();
                        _t.label = 34;
                    case 34:
                    ...
                    case 38:
                        ...
                        _m = (0, utils_1.decodeTxInfo)(rawTx), vrsOffset = _m.vrsOffset, txType = _m.txType, chainId = _m.chainId, chainIdTruncated = _m.chainIdTruncated;
                            ...
                            return __generator(this, function (_v) {
                                switch (_v.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this_2.transport
                        ...
                        _t.label = 39;
                    case 39:
                        if (!(offset !== rawTx.length)) return [3 /*break*/, 41];
    ...
    Eth.prototype.clearSignTransaction = function (path, rawTxHex, resolutionConfig, throwOnError) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ledger_1["default"]
                            .resolveTransaction(rawTxHex, this.loadConfig, resolutionConfig)["catch"](function (e) {
                            console.warn("an error occurred in resolveTransaction => fallback to blind signing: " +
                                String(e));
                            if (throwOnError) {
                                throw e;
    ...
    * @example
    ...
    Eth.prototype.signPersonalMessage = function (path, messageHex) {
        return __awaiter(this, void 0, void 0, function () {
            var paths, offset, message, response, _loop_3, this_3, v, r, s;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        paths = (0, utils_1.splitPath)(path);
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this_3.transport.send(0xe0, 0x08, offset === 0 ? 0x00 : 0x80, 0x00, buffer)];
                                    case 1:
                                        response = _b.sent();
                                        offset += chunkSize;
                                        return [2 /*return*/];
    ...
    * @example
     ...
     */
    Eth.prototype.getChallenge = function () {
        return __awaiter(this, void 0, void 0, function () {
            var APDU_FIELDS;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.transport
                        ...
                        .then(function (res) {
                        var _a = __read(new RegExp("(.*)(.{4}$)").exec(res.toString("hex")) || [], 3), fourBytesChallenge = _a[1], statusCode = _a[2];
                        if (statusCode !== "9000") {
                            throw new Error("An error happened while generating the challenge. Status code: ".concat(statusCode));
                        }
                        return "0x".concat(fourBytesChallenge);
                    })["catch"](function (e) {
     ...
     * @returns a boolean
     */
    Eth.prototype.provideERC20TokenInformation = function (data) {
        var buffer = Buffer.from(data, "hex");
        return this.transport.send(0xe0, 0x0a, 0x00, 0x00, buffer).then(function () { return true; }, function (e) {
            if (e && e.statusCode === 0x6d00) {
     ...
     * @returns a boolean
     */
    Eth.prototype.setExternalPlugin = function (payload, signature) {
        ...
        return this.transport.send(0xe0, 0x12, 0x00, 0x00, buffer).then(function () { return true; }, function (e) {
            if (e && e.statusCode === 0x6a80) {
    ...
    Eth.prototype.setPlugin = function (data) {
        var buffer = Buffer.from(data, "hex");
        return this.transport.send(0xe0, 0x16, 0x00, 0x00, buffer).then(function () { return true; }, function (e) {
            if (e && e.statusCode === 0x6a80) {
                // this case happen when the plugin name is too short or too long
                return false;
            }
     ...
     * @returns a boolean
     */
    Eth.prototype.provideNFTInformation = function (data) {
        var buffer = Buffer.from(data, "hex");
        return this.transport.send(0xe0, 0x14, 0x00, 0x00, buffer).then(function () { return true; }, function (e) {
            if (e && e.statusCode === 0x6d00) {
     ...
     * @returns a boolean
     */
    Eth.prototype.provideDomainName = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var APDU_FIELDS, buffer, payload, bufferChunks, bufferChunks_1, bufferChunks_1_1, chunk, isFirstChunk, e_6_1;
            var e_6, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        bufferChunks = new Array(Math.ceil(payload.length / 256))
                            .fill(null)
                            .map(function (_, i) { return payload.slice(i * 255, (i + 1) * 255); });
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, 7, 8]);
                        bufferChunks_1 = __values(bufferChunks), bufferChunks_1_1 = bufferChunks_1.next();
                        _b.label = 2;
                    case 2:
                        if (!!bufferChunks_1_1.done) return [3 /*break*/, 5];
                        chunk = bufferChunks_1_1.value;
                        isFirstChunk = chunk === bufferChunks[0];
                        return [4 /*yield*/, this.transport.send(APDU_FIELDS.CLA, APDU_FIELDS.INS, isFirstChunk
                    ...
                    case 3:
                        ...
                        _b.label = 4;
                    case 4:
                        bufferChunks_1_1 = bufferChunks_1.next();
                        return [3 /*break*/, 2];
                    ...
                    case 7:
                        try {
                            if (bufferChunks_1_1 && !bufferChunks_1_1.done && (_a = bufferChunks_1["return"])) _a.call(bufferChunks_1);
                        }
