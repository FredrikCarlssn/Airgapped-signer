...
export var mergeResolutions = function (resolutionsArray) {
    var e_1, _a, _b;
    var mergedResolutions = {
        nfts: [],
        erc20Tokens: [],
        externalPlugin: [],
        plugin: [],
    ...
    try {
        for (var resolutionsArray_1 = __values(resolutionsArray), resolutionsArray_1_1 = resolutionsArray_1.next(); !resolutionsArray_1_1.done; resolutionsArray_1_1 = resolutionsArray_1.next()) {
            var resolutions = resolutionsArray_1_1.value;
            for (var key in resolutions) {
                (_b = mergedResolutions[key]).push.apply(_b, __spreadArray([], __read(resolutions[key]), false));
            }
        }
    }
        ...
        try {
            if (resolutionsArray_1_1 && !resolutionsArray_1_1.done && (_a = resolutionsArray_1["return"])) _a.call(resolutionsArray_1);
        }
