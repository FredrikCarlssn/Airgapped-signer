...
describe("import ton Jetton tokens", () => {
    beforeEach(() => {
        mockedAxios.mockImplementation(() => Promise.resolve({ data: tonJetton, headers: { etag: "etagHash" } }));
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
...
`;
        ...
        yield (0, _1.importTonJettonTokens)(".");
...
//# sourceMappingURL=ton-jetton.test.js.map