...
import { FilecoinERC20Token } from "./data/filecoin-erc20";
...
export declare function convertERC20([parentCurrencyId, token, ticker, magnitude, name, ledgerSignature, contractAddress, disableCountervalue, delisted,]: ERC20Token | PolygonERC20Token | FilecoinERC20Token): TokenCurrency | undefined;
...
export declare function convertJettonToken([address, name, ticker, magnitude, delisted, enableCountervalues,]: TonJettonToken): TokenCurrency | undefined;
export {};
